...
```{r}
msi1<- glm(Exercise~Hours.Slept*Breakfast + I(Hours.Slept^2) + avg.commute, data=data, family= poisson)
...
```{r}
m.s.i<- glm(Exercise~Hours.Slept*Breakfast + I(Hours.Slept^2), data=data, family= poisson)
summary(m.s.i)
#AIC = 372.53
# No overdispersion
```
...
# Task 3: Results
Hours of sleep has a significant effect on the number of times and individual exercises (), 

There was no significant interaction between the effects of hours of sleep and breakfast on 

(χ2 1,85 = 3.9976, p=0.04557). 


There was a significant quadratic relationship between the the number of times and individual exercised and hours slept (b±SE = 0.852±0.245; Z-Value 1,85 = -2.3066; P =0.0211).
