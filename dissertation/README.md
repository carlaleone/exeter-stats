...
### Folders:
- [data](https://github.com/carlaleone/exeter-stats/tree/main/dissertation/data): contains the [DNA concentration data](https://github.com/carlaleone/exeter-stats/blob/main/dissertation/data/new_qubit.xls) from Qubit assays and the [metabarcoding data](https://github.com/carlaleone/exeter-stats/blob/main/dissertation/data/metabarcoding_results.csv) which is the 'Sample Details' file from the MitoFish pipeline performed on the sequencing output from Exeter Sequencing.
